...
type CalculatorClient interface {
	Calculate(ctx context.Context, in *OperationsRequest, opts ...grpc.CallOption) (*OperationsResponse, error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, in *OperationsRequest, opts ...grpc.CallOption) (*OperationsResponse, error) {
...
type CalculatorServer interface {
	Calculate(context.Context, *OperationsRequest) (*OperationsResponse, error)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *OperationsRequest) (*OperationsResponse, error) {
...
func _Calculator_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServer).Calculate(ctx, req.(*OperationsRequest))
	}
